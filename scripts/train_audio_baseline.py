...
# ============================================================
# Audio baseline: BiLSTM over per-utterance MFCC feature vector
# (Phase 0 spec: "BiLSTM-on-handcrafted-features (audio)")
# ============================================================
...
if len(feature_cols) == 0:
    print("ERROR: no columns starting with 'mfcc_' found. Actual columns:")
...
# Normalize features using train-set statistics only (no leakage)
...
# ---- Model: treat 39-dim MFCC vector as a length-39 sequence of 1-dim steps,
# fed through a BiLSTM, matching the Phase 0 "BiLSTM-on-handcrafted-features" spec ----
...
model = BiLSTMAudioClassifier(input_dim=len(feature_cols), num_classes=len(labels)).to(device)
...
print("\n" + "="*60)
print("AUDIO BASELINE (BiLSTM on MFCC) - TEST RESULTS")
print("="*60)
...
}, "models/audio_baseline/bilstm_mfcc_baseline.pt")
print("\nSaved model to models/audio_baseline/bilstm_mfcc_baseline.pt")
